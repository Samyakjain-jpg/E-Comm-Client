          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Interior Design Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Interior Design Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge Interior Design will use my information in accordance
              with its
