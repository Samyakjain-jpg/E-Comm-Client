  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with Interior Design! We appreciate your business
        ...
        <p>
          ...
          agreed to in writing by Interior Design.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to Interior Design's acceptance. We may refuse to
        ...
        <p>
          ...
          Interior Design. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock Interior Design products. We
        ...
        <p>
          ...
          taxes, except for those based on Interior Design's income. If
          Interior Design is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without Interior Design's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold Interior Design harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between Interior Design and
