  ...
  return (
    <div className="container__0">
      ...
      <div className="content-container">
        <p>
        Thank you for choosing [Your Interior Design Business Name] for your design needs! We strive to ensure your satisfaction with every project. If you are not completely satisfied with our services, we offer a return policy to address your concerns.
        </p>
        <p>
        Thank you for choosing [Your Interior Design Business Name] for your design needs! We strive to ensure your satisfaction with every project. If you are not completely satisfied with our services, we offer a return policy to address your concerns.
        </p>
