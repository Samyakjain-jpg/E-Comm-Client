    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, Interior Design.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with Interior Design
          ...
          agreed to or set forth in writing by Interior Design, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to Interior Design's acceptance. This means
          Interior Design may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, Interior Design
        ...
        <p>
          ...
          and it is accepted by Interior Design. Prices for products displayed on
          ...
          website may differ from those in stores that stock Interior Design
          products, as these stores are independent of Interior Design.
          Interior Design reserves the right to amend pricing for any pricing
          ...
          submitted an online order, Interior Design will notify you of the error
        ...
        <p>
          ...
          Interior Design reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Interior Design if it pays, any
          taxes, except for those based on Interior Design's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Interior Design for when the
          ...
          are beyond our control. Interior Design cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Interior Design, customer
          may not cancel such accepted order without Interior Design’s prior
          ...
          expenses. The product(s) must be returned to Interior Design within
        ...
        <p>
          ...
          indemnify and hold Interior Design harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>Interior Design</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@Interior Design.com</span>
        </p>
      </div>
    </div>
  );
